...
const Home = () => {
    return (
        <Layout>
            ...
            <div className="container">
                <div className="hero is-fullheight has-text-centered">
                    <div className="content has-text-white">
                        ...
                        <p> </p>
                        <h3 className="content has-text-white">Sonirepro es la aplicación definitiva para los amantes de la música. Sube tus canciones, crea playlists personalizadas y comparte tus gustos musicales con amigos. Todo en un solo lugar.</h3>
                    </div>
                </div>
            </div>
            </section>
            ...
            <section className="section has-background-light">
            <div className="container has-background-beige">
            ...
            <div className="container">
                ...
                <div className="column is-half is-vertical-center">
                    ...
                    <p>Organiza tus canciones favoritas en playlists personalizadas. Ya sea para una sesión de ejercicio, un viaje por la ruta o simplemente para relajarte, <strong>Sonirepro</strong> tiene todo lo que necesitas.</p>
                    </div>
                </div>
                </div>
            </div>
